...
$logo_url = "http://192.168.0.57/arbimaps/Arbimaps/assets/img/logo_final_arbitrium.png";
?>
<title>Ticket <?php echo htmlspecialchars($ticket['codigo_error']); ?></title>
<style>
    :root {
        --ticket-bg-img: url("http://192.168.0.57/arbimaps/Arbimaps/assets/img/logo_final_arbitrium.png");
        --bg-size: 380px;
    }
