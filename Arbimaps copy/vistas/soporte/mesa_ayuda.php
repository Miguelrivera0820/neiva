                    ...
                    <div class="tickets-container ">
                        <?php while ($row = $resultado->fetch_assoc()):
                            ...
                            $imgSrc = !empty($row['imagen_ruta']) ?
                                '/arbimaps/Arbimaps/vistas/soporte/' . $row['imagen_ruta'] : null;
                        ?>
                                ...
                                <div class="ticket-details d-none">
                                    ...
                                    <div class="action-buttons">
                                        ...
                                        <?php if ($config['nuevo_estado']): ?>
                                            <form method="POST"
                                                action="/arbimaps/Arbimaps/vistas/soporte/acciones/cambiar_estado.php"
                                                class="flex-fill">
                                        ...
                                        <?php if (!empty($config['asignacion_error'])): ?>
                                            ...
                                            <a href="/arbimaps/Arbimaps/index.php?page=soporte/asignar_error&codigo=<?php echo $codigo_for_url; ?>"
