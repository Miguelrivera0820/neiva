                    ...
                    <?php foreach ($estados as $estado): ?>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td class="text-center" style="font-size: 13px">
                                        <a href="/arbimaps/Arbimaps/index.php?page=soporte/chat_soporte&codigo=<?php echo urlencode($row['codigo_error']); ?>"
...
<script>
    ...
    function inicializarNotificacionesChatSoporte() {
        ...
        function actualizarNotificacionesSoporte() {
            ...
            var url = '/arbimaps/Arbimaps/vistas/soporte/chat_notificaciones_soporte.php' +
