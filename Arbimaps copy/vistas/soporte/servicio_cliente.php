                                        ...
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-8 rounded-3 p-2">
                                                    ...
                                                    $href_chat = "/arbimaps/Arbimaps/index.php?page=soporte/chat_soporte&codigo=" . urlencode($codigoTicket);
                                                    ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function revisarBloqueos() {
            ...
            var url = '/arbimaps/Arbimaps/vistas/soporte/chat_bloqueos.php?codigos=' +
        ...
        function actualizarNotificacionesChat() {
            ...
            var url = '/arbimaps/Arbimaps/vistas/soporte/chat_notificaciones.php?codigos=' +
                encodeURIComponent(codigos.join(','));
...
<script>
    function imprimirTicket(codigo) {
        ...
        var url = '/arbimaps/Arbimaps/index.php?page=soporte/imprimir_solicitud&codigo=' + encodeURIComponent(codigo);
        iframe.onload = null;
