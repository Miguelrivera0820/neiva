...
//Consulta para contar las cuentas aprobadas por gerencia
$sqlCount = "SELECT COUNT(*) AS total 
             FROM solicitud_baqueanos 
             WHERE sb_estado_gerencia = 'APROBADO' 
...
<div class="container-fluid">
    <div class="my-4 text-center">
        <h4 class=" mb-0 fw-bold mb-2" style="color: #002F55; font-weight: 700 !important ">SOLICITUDES DEVUELTAS</h4>
        <small>gestion de solicitudes devueltas</small>
    </div>
    <div class="row mt-5">
        <div class="col-lg-12">
                    ...
                    <div class="d-flex align-items-center ">
                        ...
                        <div>
                            ...
                            <div style="font-size: 70%; color: #f3f8fdff;" class="text-start">
                                Solicitudes que fueron aprobadas por el lider de reconocimiento
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table  table-card text-center align-middle" id="dataTable" width="100%" cellspacing="0">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th style="text-align: center; vertical-align: middle; font-size: 12px">Documento</th>
                                    <th style="text-align: center; vertical-align: middle; font-size: 12px">Cantidad de dias</th>
                                    <th style="text-align: center; vertical-align: middle; font-size: 12px">valor del dia</th>
                            ...
                            <tbody>
                                ...
                                FROM solicitud_baqueanos 
                                WHERE 
                                    (sb_estado_gerencia = 'DEVUELTO' OR sb_estado_operaciones = 'DEVUELTO')
                                ...
                                if ($stmt = $mysqli->prepare($sql2)) {
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            echo "<tr>";
                                            echo "<td><a href='informacion_sol_devuelta.php?id=" . urlencode($row['id']) . "' class='rad btn-link'>ARB_" . htmlspecialchars($row['id']) . "</a></td>";
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        fetch("cargar_notificaciones_profesional_social.php")
