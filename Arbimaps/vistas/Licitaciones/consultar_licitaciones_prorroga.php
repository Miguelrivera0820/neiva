            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered table-hover" id="dataTableProrroga" width="100%" cellspacing="0">
                            <thead>
...
$(document).ready(function() {
    if ($.fn.DataTable.isDataTable('#dataTableProrroga')) {
        $('#dataTableProrroga').DataTable().destroy();
    }

    $('#dataTableProrroga').DataTable({
        language: {
