...
$mesaAyudaUrl = neiva_app_url('Arbimaps/index.php?page=soporte/mesa_ayuda');
$asignacionAction = neiva_app_url('Arbimaps/vistas/soporte/acciones/asignacion_error.php');

if (!$codigo) {
    echo '<div class="container mt-4">';
    echo '<div class="alert alert-warning">Código de error no especificado.</div>';
    echo '<a href="' . htmlspecialchars($mesaAyudaUrl, ENT_QUOTES, 'UTF-8') . '" class="btn btn-secondary">Volver</a>';
    echo '</div>';
    return;
}
    ...
    <div class="row  h-100 justify-content-center align-items-center">
            ...
            <div class="card shadow border rounded-4  px-0">
                <div class="card-header d-flex justify-content-between align-items-center px-4  py-3" style="background-color: #002f5526;">
                    ...
                    <div class="contenedor-boton-volver">
                        <a href="<?php echo htmlspecialchars($mesaAyudaUrl, ENT_QUOTES, 'UTF-8'); ?>"
                            class="boton-volver">
        ...
        <div class="col-12 col-lg-4">
            <div class="card card shadow my-3  p-2 py-3">
                ...
                <form action="<?php echo htmlspecialchars($asignacionAction, ENT_QUOTES, 'UTF-8'); ?>" method="POST">
        ...
        (function() {
            ...
            if (estado === "ok") {
                Swal.fire({
                    ...
                    window.location.href = <?php echo json_encode($mesaAyudaUrl); ?>;
                });
            }
