...
$rolesPermitidos = array("administrador", "soporte", "gerencia");
...
<div class="container-fluid">
    ...
    <div class="my-4 text-center">
        ...
        <small>Información para gerencia</small>
    </div>

    <form id="formulario_editar" action="./vistas/baqueanos/solicitudes/acciones/acciones_gerencia.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="tab-content p-3">
            <div class="tab-pane fade show active" id="pane-seccionUno" role="tabpanel" aria-labelledby="tab-seccionUno" tabindex="0">
                <div class="card rounded-4 shadow-sm border-0 section-one-card form-section" id="section1">
                    <div class="card-body p-4">
                        <div class="ticket-bite p-2 w-50 text-center text-white rounded-4 bg-brand" style="left:1%;">
                            ...
                            <small>Datos del solicitante y cuenta</small>
                        </div>
                        ...
                        <div class="row mt-5">
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="id_mostrar" style="font-size:0.9em;" value="ARB_<?php echo htmlspecialchars($id ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_tipo_documento" value="<?php echo htmlspecialchars($sb_tipo_documento ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_numero_identidad" value="<?php echo htmlspecialchars($sb_numero_identidad ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_baqueano_nombre" value="<?php echo htmlspecialchars($sb_baqueano_nombre ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    <span class="input-group-text"><i class="bi bi-person"></i></span>
                                    <input class="form-control" id="sb_baqueano_apellido" value="<?php echo htmlspecialchars($sb_baqueano_apellido ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_telefono_baqueano" value="<?php echo htmlspecialchars($sb_telefono_baqueano ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_correo_baqueano" value="<?php echo htmlspecialchars($sb_correo_baqueano ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_direccion" value="<?php echo htmlspecialchars($sb_direccion ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
            ...
            <div class="tab-pane fade" id="pane-seccionDos" role="tabpanel" aria-labelledby="tab-seccionDos" tabindex="0">
                <div class="card rounded-4 shadow-sm border-0 section-one-card form-section d-none mt-0" id="section2">
                    <div class="card-body p-4">
                        ...
                        <div class="row mt-0">
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" name="sb_profesional_baqueano" id="sb_profesional_baqueano" value="<?php echo htmlspecialchars($sb_profesional_baqueano ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    <span class="input-group-text"><i class="bi bi-person-workspace"></i></span>
                                    <input class="form-control" id="sb_coordinador" value="<?php echo htmlspecialchars($sb_coordinador ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_year" value="<?php echo htmlspecialchars($sb_year ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input type="date" class="form-control" id="sb_fecha_inicio_view" value="<?php echo htmlspecialchars($sb_fecha_inicio ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input type="date" class="form-control" id="sb_fecha_fin_view" value="<?php echo htmlspecialchars($sb_fecha_fin ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_dias_calculados_view" value="<?php echo htmlspecialchars($sb_dias_calculados ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_cobro_diario_view" value="<?php echo htmlspecialchars($valorFormateado ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_valor_cobrar_view" value="<?php echo htmlspecialchars($valorFormateado1 ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body p-4">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                                <div>
                                                    ...
                                                    <small class="text-muted">Se agregaron <b><?php echo (int)$ext_dias_agregados; ?></b> días</small>
                                                    <?php if ($extCreatedAtFmt): ?>
                                                        <div class="mt-1" style="font-size:12px;">
                                                            Registrada: <?php echo htmlspecialchars($extCreatedAtFmt, ENT_QUOTES, 'UTF-8'); ?>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-6 col-lg-4">
                                                    ...
                                                    <div class="input-group shadow-sm rounded-2 precargado">
                                                        ...
                                                        <input class="form-control" value="<?php echo (int)$ext_dias_agregados; ?>" disabled>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-lg-4">
                                                    ...
                                                    <div class="input-group shadow-sm rounded-2 precargado">
                                                        ...
                                                        <input type="date" class="form-control" value="<?php echo htmlspecialchars($extFechaNuevaFmt, ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-lg-4">
                                                    ...
                                                    <div class="input-group shadow-sm rounded-2 precargado">
                                                        ...
                                                        <input class="form-control" value="<?php echo (int)$ext_dias_nuevo_total; ?>" disabled>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-lg-6">
                                                    ...
                                                    <div class="input-group shadow-sm rounded-2 precargado">
                                                        <span class="input-group-text"><i class="bi bi-cash-coin"></i></span>
                                                        <input class="form-control" value="<?php echo htmlspecialchars($extValorAdicionalFmt, ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-lg-6">
                                                    ...
                                                    <div class="input-group shadow-sm rounded-2 precargado">
                                                        <span class="input-group-text"><i class="bi bi-currency-dollar"></i></span>
                                                        <input class="form-control" value="<?php echo htmlspecialchars($extValorNuevoTotalFmt, ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                                    </div>
                                                </div>
                                                ...
                                                <?php if (!empty($ext_observacion)): ?>
                                                    <div class="col-12">
                                                        ...
                                                        <div class="input-group shadow-sm rounded-2 precargado">
                                                            ...
                                                            <input class="form-control" value="<?php echo htmlspecialchars($ext_observacion, ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_unidad_intervencion_view" value="<?php echo htmlspecialchars($sb_unidad_intervencion ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_unidad_operativa_view" value="<?php echo htmlspecialchars($sb_unidad_operativa ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_tipo_unidad_view" value="<?php echo htmlspecialchars($sb_tipo_unidad ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_municipio_view" value="<?php echo htmlspecialchars($sb_municipio ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_vereda_view" value="<?php echo htmlspecialchars($sb_vereda ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_tipo_actividad_view" value="<?php echo htmlspecialchars($sb_tipo_actividad ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6 p-1 px-2 my-3" id="grupo_lider" style="display:none;">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_lider_cuadrilla" value="<?php echo htmlspecialchars($sb_lider_cuadrilla ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6 p-1 px-2 my-3" id="grupo_reconocedor" style="display:none;">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_reconocedor" value="<?php echo htmlspecialchars($sb_reconocedor ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_transporte_mostrar" value="<?php echo htmlspecialchars($sb_transporte ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                                ...
                                <div class="row g-0">
                                    <div class="col-md-6 col-lg-6 p-1 px-2 my-3">
                                        ...
                                        <div class="input-group shadow-sm rounded-2 precargado">
                                            ...
                                            <input class="form-control" id="grupo_mostrar_transporte" value="<?php echo htmlspecialchars($sb_porque_transporte ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 p-1 px-2 my-3" id="campo_cuanto_transporte" style="display:none;">
                                        ...
                                        <div class="input-group shadow-sm rounded-2 precargado">
                                            <span class="input-group-text"><i class="bi bi-cash-coin"></i></span>
                                            <input class="form-control" name="sb_cuanto_transporte" value="<?php echo htmlspecialchars($valorFormateado3 ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 p-1 px-2 my-3">
                                ...
                                <div class="input-group shadow-sm rounded-2 precargado">
                                    ...
                                    <input class="form-control" id="sb_hospedaje_mostrar" value="<?php echo htmlspecialchars($sb_hospedaje ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-8 p-0 m-0" id="grupo_mostrar_hospedaje" style="display:none;">
                                <div class="row g-0">
                                    <div class="col-md-6 col-lg-6 p-1 px-2 my-3">
                                        ...
                                        <div class="input-group shadow-sm rounded-2 precargado">
                                            <span class="input-group-text"><i class="bi bi-question-circle"></i></span>
                                            <input class="form-control" id="grupo_mostrar_hospedaje" value="<?php echo htmlspecialchars($sb_porque_hospedaje ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 p-1 px-2 my-3" id="campo_cuanto_hospedaje" style="display:none;">
                                        ...
                                        <div class="input-group shadow-sm rounded-2 precargado">
                                            ...
                                            <input class="form-control" name="sb_cuanto_hospedaje" value="<?php echo htmlspecialchars($valorFormateado4 ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                                        <div>
                                            ...
                                            <small class="text-muted">Seleccione el motivo y escriba la observación</small>
                                        </div>
                                    ...
                                    <label for="sb_tipo_motivo" class="form-label fw-bold" style="font-size:0.9em;">Motivo de la devolución</label>
                                    <div class="input-group shadow-sm rounded-2 precargado mb-2">
                                        <span class="input-group-text"><i class="bi bi-exclamation-circle"></i></span>
                                        <select class="form-control" id="sb_tipo_motivo" name="sb_tipo_motivo">
                                    ...
                                    <div id="otroMotivoContainer" style="display: none;">
                                        <div class="input-group shadow-sm rounded-2 precargado mt-2 mb-2">
                                            <span class="input-group-text"><i class="bi bi-pencil-square"></i></span>
                                            <input type="text" class="form-control" id="otro_motivo" name="otro_motivo" placeholder="Escriba el motivo">
                                        </div>
                                    </div>

                                    <label for="sb_razon_gerencia" class="form-label fw-bold" style="font-size:0.9em;">Observación</label>
                                    <div class="input-group shadow-sm rounded-2 precargado">
                                        <span class="input-group-text"><i class="bi bi-chat-left-text"></i></span>
                                        <textarea class="form-control" id="sb_razon_gerencia" name="sb_razon_gerencia" rows="3"
                                ...
                                <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden modalPro">
                                    <form id="formulario_editar_modal">
                                            ...
                                            <section id="sec-ubicacion" class="modalSectionPro">
                                                ...
                                                <div class="row g-3 mt-2">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group shadow-sm rounded-3 precargado">
                                                            <span class="input-group-text"><i class="bi bi-building"></i></span>
                                                            <select class="custom-select form-control" name="sb_unidad_operativa" id="sb_unidad_operativa" name="sb_unidad_operativa">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group shadow-sm rounded-3 precargado">
                                                            <span class="input-group-text"><i class="bi bi-tags"></i></span>
                                                            <select class="custom-select form-control" name="sb_tipo_unidad" id="sb_tipo_unidad" name="sb_tipo_unidad">
                                                    ...
                                                    <div class="col-md-6" id="grupo_coordinador" style="display:none;">
                                                        <label class="form-label fw-bold" style="font-size:0.9em;" for="sb_coordinador"><b>Coordinador</b></label>
                                                        <div class="input-group shadow-sm rounded-3 precargado">
                                                            <span class="input-group-text"><i class="bi bi-person-workspace"></i></span>
                                                    ...
                                                    <div class="col-md-6" id="grupo_lider" style="display:none;">
                                                        <label class="form-label fw-bold" style="font-size:0.9em;" for="sb_lider_cuadrilla"><b>Líder de Cuadrilla</b></label>
                                                        <div class="input-group shadow-sm rounded-3 precargado">
                                                            <span class="input-group-text"><i class="bi bi-person-check"></i></span>
                                            ...
                                            <section id="sec-logistica" class="modalSectionPro">
                                                ...
                                                <div class="row g-3 mt-2">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group shadow-sm rounded-3 precargado">
                                                            <span class="input-group-text"><i class="bi bi-truck"></i></span>
                                                            <select class="custom-select form-control" id="sb_transporte" name="sb_transporte" onchange="mostrarPorque()">
                                                    ...
                                                    <div class="col-md-6" id="grupo_porque" style="display:none;">
                                                    ...
                                                    <div class="col-md-6" id="grupo_cuanto_transporte" style="display:none;">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group shadow-sm rounded-3 precargado">
                                                            <span class="input-group-text"><i class="bi bi-house-door"></i></span>
                                                            <select class="custom-select form-control" id="sb_hospedaje" name="sb_hospedaje" onchange="mostrarHospedaje()">
                                                    ...
                                                    <div class="col-md-6" id="grupo_hospedaje" style="display:none;">
                                                    ...
                                                    <div class="col-md-6" id="grupo_cuanto_hospedaje" style="display:none;">
                                        ...
                                        <div class="modal-footer modalFooterPro">
                                            <button type="submit" class="btn btn-brand px-4 d-inline-flex align-items-center gap-2">
...
<script>
    ...
    const selectMotivo = document.getElementById('sb_tipo_motivo');
    ...
    function accionFormulario(accion) {
        ...
        if (accion === 'devolver') {
            ...
            document.getElementById('sb_razon_gerencia').focus();
            return;
        }
        ...
        if (accion === 'aprobar') {
            ...
            mensaje = 'La solicitud será aprobada definitivamente.';
            ...
            <div class="swal-saved-card">
                ...
                <div class="swal-saved-body">
                    ...
                    <div class="mt-4 d-flex justify-content-center gap-2">
                        ...
                        <button onclick="confirmarAccion('${accion}')"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const enviarDevolucion = document.getElementById("enviar-devulucion");

        if (btnDevolver && campoObservacion && enviarDevolucion) {
            btnDevolver.addEventListener("click", function() {
                campoObservacion.style.display = "block";
            });

            enviarDevolucion.addEventListener("click", function(event) {
                event.preventDefault();

                const razon = document.getElementById("sb_razon_gerencia").value.trim();
                const id = document.getElementById("id").value;
                const motivo = document.getElementById("sb_tipo_motivo").value;
    ...
    document.addEventListener("DOMContentLoaded", function() {
        function mostrarCamposTransporte() {
            ...
            const grupoCuanto = document.getElementById("campo_cuanto_transporte");

            if (transporte === "SI") {
                if (grupoPorque) grupoPorque.style.display = "block";
                if (grupoCuanto) grupoCuanto.style.display = "block";
            } else {
                if (grupoPorque) grupoPorque.style.display = "none";
                if (grupoCuanto) grupoCuanto.style.display = "none";
            }
        }
        ...
        function mostrarCamposHospedaje() {
            ...
            const grupoCuanto = document.getElementById("campo_cuanto_hospedaje");
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(event) {
            ...
            fetch("./vistas/baqueanos/solicitudes/acciones/acciones_gerencia.php", {
                    method: "POST",
                    body: formData
                })
    ...
    function mostrarPorque() {
        ...
        const grupoCuanto = document.getElementById("grupo_cuanto_transporte");
    ...
    document.addEventListener("DOMContentLoaded", mostrarPorque);
    ...
    function mostrarHospedaje() {
        ...
        const grupoCuanto = document.getElementById("grupo_cuanto_hospedaje");
        ...
        if (valor === "SI") {
            if (grupoHospedaje) grupoHospedaje.style.display = "block";
            if (grupoCuanto) grupoCuanto.style.display = "block";
        } else {
            if (grupoHospedaje) grupoHospedaje.style.display = "none";
            if (grupoCuanto) grupoCuanto.style.display = "none";
            if (inputPorque) inputPorque.value = "";
            if (inputCuanto) inputCuanto.value = "";
        }
    ...
    document.addEventListener("DOMContentLoaded", mostrarHospedaje);
    ...
    function prevSection() {
        if (currentSectionIndex > 1) {
            currentSectionIndex--;
            showSection(currentSectionIndex);
            document.getElementById('tab-seccionUno')?.click();
        }
    }
    ...
    function actualizarBotones(index) {
        document.querySelectorAll('.section-btn').see?.forEach(btn => {
