...
$rolesPermitidos = array("administrador", "director_catastro", "director_proyectos", "Directivos", "soporte");
...
<style>
    ...
    .doc-head {
        padding: 12px 14px;
        background: linear-gradient(135deg, rgba(0, 47, 85, .06) 0%, rgba(11, 90, 160, .08) 100%);
    ...
    /* para que el ícono también cambie a blanco */
    .btn-aprobar-custom:hover i {
        color: #fff;
    }

    /* opcional: pequeño “click effect” */
...
<div class="container-fluid page-wrap">
    <div class="my-4 text-center">
        <h4 class="mb-1 page-title">CUENTAS RADICADAS BAQUEANOS</h4>
        <div class="subtle">En este módulo está la cuenta radicada por el personal baqueano.</div>
    </div>

    <div class="container-xl my-4">
        <form id="formulario_editar" action="./vistas/baqueanos/solicitudes/acciones/acciones_operaciones.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row gy-3 gx-3">
                                    <div class="col-12 col-md-6">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_tipo_documento ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_numero_identidad ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_baqueano_nombre ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_baqueano_apellido ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_telefono_baqueano ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="info-box text-center">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_correo_baqueano ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_year ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_fecha_inicio ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_fecha_fin ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_dias_calculados ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($valorFormateado ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($valorFormateado1 ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_unidad_intervencion ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_unidad_operativa ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_tipo_unidad ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_municipio ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_vereda ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="info-box">
                                            ...
                                            <div class="info-value"><?php echo htmlspecialchars($sb_profesional_baqueano ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>

                                    <div class="col-12 col-md-6">
                                        <div class="info-box">
                                            <div class="info-label">Observaciones (baqueano)</div>
                                            <div class="info-value"><?php echo htmlspecialchars($sb_observacion_cuenta ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="doc-card mb-2 h-100 w-100">
                                        <div class="doc-body py-2">
                                            <div class="doc-file mb-2">
                                                <div class="info-label text-center fw-bold">Cédula</div>
                                                <div class="info-label text-center">
                                                    <?php echo htmlspecialchars($row['sb_cedula_baqueano'] ?? '', ENT_QUOTES, 'UTF-8'); ?>
                                                </div>
                                            </div>
                                            <?php
                                            ...
                                            ?>
                                                ...
                                                <iframe src="<?php echo htmlspecialchars($ruta, ENT_QUOTES, 'UTF-8'); ?>"
                                                    ...
                                                    style="height:<?php echo $iframe_h; ?>px"
                                            ...
                                            ?>
                                                ...
                                                <div class='subtle small text-center d-flex align-items-center justify-content-center'
                                                    style='height:<?php echo $iframe_h; ?>px'>No hay documento cargado.</div>
                                            <?php
                                            }
                                            ?>
                                        </div>
                                    ...
                                    <div class="doc-card mb-2 h-100 w-100">
                                        <div class="doc-body py-2">
                                            <div class="doc-file mb-2">
                                                ...
                                                <div class="info-label text-center">
                                                    <?php echo htmlspecialchars($row['sb_rut_baqueano'] ?? '', ENT_QUOTES, 'UTF-8'); ?>
                                                </div>
                                            </div>
                                            <?php
                                    ...
                                    <div class="doc-card mb-2 h-100 w-100">
                                        <div class="doc-body py-2">
                                            <div class="doc-file mb-2">
                                                ...
                                                <div class="info-label text-center">
                                                    <?php echo htmlspecialchars($row['sb_certificado_baqueano'] ?? '', ENT_QUOTES, 'UTF-8'); ?>
                                                </div>
                                            </div>
                                            <?php
                                    ...
                                    <div class="doc-card mb-2 h-100 w-100">
                                        <div class="doc-body py-2">
                                            <div class="doc-file mb-2">
                                                ...
                                                <div class="info-label text-center">
                                                    <?php echo htmlspecialchars($row['sb_cuenta_baqueano'] ?? '', ENT_QUOTES, 'UTF-8'); ?>
                                                </div>
                                            </div>
                                            <?php
...
<script>
    function accionFormulario(accion) {
        ...
        if (accion === 'devolver') {
            ...
            document.getElementById('sb_razon_cuenta').focus();
            return;
        }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        btnEnviar.addEventListener('click', function(e) {
            e.preventDefault();
            const razon = document.getElementById('sb_razon_cuenta').value.trim();
            if (!razon) {
                Swal.fire({
                    customClass: {
                        popup: 'swal-pro',
