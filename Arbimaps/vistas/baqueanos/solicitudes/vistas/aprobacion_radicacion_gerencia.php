...
<div class="container-fluid">
    <div class="my-4 text-center">
        <h4 class=" mb-0 fw-bold mb-2" style="color: #002F55; font-weight: 700 !important ">APROBACION RADICACION SUBGERENCIA</h4>
        <small>Lista de radicaciones aprobadas por el jefe de operaciones</small>
    </div>
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="d-flex align-items-center ">
                        ...
                        <div>
                            ...
                            <div style="font-size: 70%; color: #f3f8fdff;" class="text-start">
                                Lista de radicaciones de solicicitudes que han sido aprobadas
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table  table-card text-center align-middle" id="dataTable" width="100%" cellspacing="0">
                            ...
                            AND sb_estado_cuenta = 'APROBADO'
                            AND sb_estado_gerencia = 'APROBADO'
                            AND sb_estado_pagos = 'PENDIENTE'
                                ...
                                if ($stmt = $mysqli->prepare($sql2)) {
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            echo "<tr>";
                                            echo "<td><a href='index.php?page=baqueanos/solicitudes/vistas/revisar_baqueanos_operaciones&id=" . urlencode($row['id']) . "' class='rad btn-link'>ARB_" . htmlspecialchars($row['id']) . "</a></td>";
