...
// =========================
// Cargar datos de contratacion si viene con_num_identidad
// =========================
            ...
            <form id="formContratacion" action="/arbimaps/Arbimaps/vistas/Perfil/acciones/actualizar_perfil_contratacion.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 p-1 px-2 my-1">
                                            ...
                                            <div class="input-group ">
                                                ...
                                                <input type="text" class="form-control" name="con_apellidos" id="con_apellidos" value="<?php echo htmlspecialchars($con_apellidos ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                                            </div>
                                        </div>
                ...
                <div class="form-section d-none" id="section4">
                    ...
                    <div class="mt-4 d-flex justify-content-between  ">
                        ...
                        <!-- ✅ Antes iba a sección 5, ahora salta a sección 6 -->
                        <button type="button" class="btn  text-white" style="background-color: #002F55;" onclick="nextSection()">
                            Siguiente <i class="bi bi-arrow-right ms-2"></i></button>
                    </div>
                ...
                <div class="form-section d-none" id="section6">
                    ...
                    <div class="row p-4 g-3 card-especial-tres">
                        ...
                        <div class="col-12 col-md-6 p-1 px-2 my-2 py-2" id="grupo_cerIncapacidad"
                            style="<?= ($incapacitado === 'si') ? '' : 'display:none;'; ?>">
                            <label for="con_cerIncapacidad" class="form-label d-block" style="font-size:0.9em;">
                                Cargue certificado de Discapacidad
                            </label>
                            <input type="file" class="form-control w-100" id="con_cerIncapacidad" name="con_cerIncapacidad">
                        </div>
                        <div class="mt-4 d-flex justify-content-between  ">
                            <button type="button" class="btn btn-secondary text-white" style="background-color: rgba(112, 113, 114, 1);" onclick="prevSection()"
                                style="margin-right: 1cm;"> <i class="bi bi-arrow-left me-2"></i> Atrás</button>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (formEditar && btnGuardarEditar) {
            btnGuardarEditar.addEventListener('click', function(e) {
                e.preventDefault();
                formEditar.submit();
            });
        }
