...
foreach ($cols as $c) {
    switch ($c) {
        ...
        case "con_hoja_vida":
            $vals[] = $con_hoja_vida;
            break;
        case "con_certificado_eps":
            $vals[] = $con_certificado_eps;
            break;
        case "con_rut":
            $vals[] = $con_rut;
            break;
        ...
        case "con_cerTarjeta":
            $vals[] = $con_cerTarjeta;
            break;
        case "con_contraloria":
            $vals[] = $con_contraloria;
            break;
        case "con_procuraduria":
            $vals[] = $con_procuraduria;
            break;
        case "con_cumplimiento":
            $vals[] = $con_cumplimiento;
            break;
        case "con_acta":
            $vals[] = $con_acta;
            break;
        case "con_actaFi":
            $vals[] = $con_actaFi;
            break;
        case "con_cerIncapacidad":
            $vals[] = $con_cerIncapacidad;
            break;
        case "con_cerVacunacion":
            $vals[] = $con_cerVacunacion;
            break;
...
if ($stmt->execute()) {
    if ($origen === 'editar') {
        ...
        if ($stmt->affected_rows > 0) {
            header("Location: /arbimaps/Arbimaps/index.php?page=Perfil/vistas/editar_perfil_contratacion&con_num_identidad={$cedula}&guardado=ok");
            exit;
        }
        header("Location: /arbimaps/Arbimaps/index.php?page=Perfil/vistas/editar_perfil_contratacion&con_num_identidad={$cedula}&guardado=error");
        exit;
    }

    if ($stmt->affected_rows > 0) {
        send_json(["success" => true, "message" => "Datos guardados correctamente."], 200);
    }
    send_json(["success" => true, "message" => "Sin cambios."], 200);
}
