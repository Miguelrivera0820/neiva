...
<div class="container-fluid px-3">
    ...
    <div class="card-form p-3">
        ...
        <div class="card-body ">
            <form id="formContratacion" action="<?= neiva_app_url('Arbimaps/vistas/Personal/acciones/actualizacion_perfil_activo.php') ?>" method="POST" enctype="multipart/form-data">
