...
//Mostrar el valor $
$valorFormateado = '$ ' . number_format($sol_nuevo_salario, 0, ',', '.');
$valorFormateado2 = '$ ' . number_format($sol_valor_otrosi, 0, ',', '.');
...
<div class="container-fluid">
    <div class=" text-center mt-4">
        <h1 class="h3  text-center mb-0" style="color:#002F55"><b>Solicitud aprobada como viable</b></h1>
        <small class="text-muted">En este módulo puedes consultar información correspondiente a la solicitud del otro si aprobado como viable.</small>
    </div>
            ...
            <div class="card rounded-4 m-3 shadow p-2">
                <div class="container-fluid ">
                    <div class="row p-2 ">
                        ...
                        <!-- <div class="col-12 col-md-3 col-sm-6 mb-3">
                                <label class="form-label" for="sol_nueva_fecha_final">Nueva Fecha Final de Otro Si</label>
                        ...
                        <div class="col-12 text-center">
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-10 col-sm-6 my-4">
                                    ...
                                    <textarea class="form-control area-justificacion " name="sol_motivo" id="sol_motivo" readonly
...
<!-- <div class="container-fluid">
    <h1 class="mt-4 text-dark"> <b>Cambios Realizados por Gerencia<b> </h1>
    <div class="card mb-4">
                        ...
                        <form>
                            ...
                            <div class="form-section" id="section1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-3 col-sm-6 mb-3">
                                        <label class="form-label" for="sol_nuevo_rol">Nuevo Rol o Existente</label>
                                        <input class="form-control" name="sol_nuevo_rol" id="sol_nuevo_rol" value="<?php echo $sol_nuevo_rol; ?>" readonly>
                                    </div>
                                    <div class="col-12 col-md-3 col-sm-6 mb-3">
                                        <label class="form-label" for="sol_nuevo_proyecto">Nuevo Proyecto o Existente</label>
                                        <input class="form-control" name="sol_nuevo_proyecto" id="sol_nuevo_proyecto" value="<?php echo $sol_nuevo_proyecto; ?>" readonly>
                                    </div>
                                    <div class="col-12 col-md-3 col-sm-6 mb-3">
                                    ...
                                    <div class="col-12 col-md-3 col-sm-6 mb-3">
                                        <label class="form-label" for="sol_valor_otrosi">Total Otro Sí</label>
                                        <input class="form-control" name="sol_valor_otrosi" id="sol_valor_otrosi" value="<?php echo $valorFormateado2; ?>" readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label" for="sol_motivo">Justificación Técnica</label>
                                        <input class="form-control" name="sol_motivo" id="sol_motivo" value="<?php echo $sol_motivo; ?>" readonly>
                                    </div>
                                </div>
                                <input type="hidden" id="solicitud_id" value="<?php echo $id; ?>">
                            </div>
                        </form>
                    </div>
                </div>
