...
$sql = "UPDATE solicitudes_otrosi
        SET sol_estado_notificacion = 'ACEPTADO',
            sol_estado_usuario = 'ACEPTADO'
        WHERE id = ?";
...
$_SESSION['swal_aprobado_ok'] = 1;
$_SESSION['swal_aprobado_msg'] = 'La notificación se aprobó correctamente.';
