...
neiva_require_permission('menu.personalGerencia', $PERMISOS);

$idUsuario = $_SESSION['id_usuario'];
$csrfToken = neiva_csrf_token('global');
$aprobarGerenciaUrl = neiva_app_url('Arbimaps/vistas/Personal/acciones/aprobar_gerencia.php');
$rechazoGerenciaUrl = neiva_app_url('Arbimaps/vistas/Personal/acciones/rechazo_gerencia.php');
$modificarGerenciaUrl = neiva_app_url('Arbimaps/vistas/Personal/acciones/modificar_gerencia.php');
$gerenciaRedirectUrl = neiva_app_url('Arbimaps/index.php?page=Personal/gerencia');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        btnAprobado.addEventListener("click", function(event) {
            ...
            Swal.fire({
                ...
                fetch(<?php echo json_encode($aprobarGerenciaUrl); ?>, {
                        method: "POST",
                        headers: {
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            Swal.fire({
                                ...
                                window.location.href = <?php echo json_encode($gerenciaRedirectUrl); ?>;
                            });
                        } else {
                            Swal.fire({
                                title: 'Error',
        ...
        enviarRechazo.addEventListener("click", function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(<?php echo json_encode($rechazoGerenciaUrl); ?>, {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                "X-CSRF-Token": <?php echo json_encode($csrfToken); ?>
        ...
        document.getElementById("btn_devolucion").addEventListener("click", function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(<?php echo json_encode($modificarGerenciaUrl); ?>, {
                            method: "POST",
                            body: formData
                        })
                        .then(res => res.json())
