...
$cod_tramite        = trim((string) ($_GET['cod'] ?? ''));
$info_cod_tramite   = $cod_tramite;

if ($cod_tramite === '') {
    if (function_exists('neiva_abort')) {
        neiva_abort(404, 'No se indicó el código del trámite solicitado.');
    }
    die('No se indicó el código del trámite solicitado.');
}
...
if (!$tramite) {
    if (function_exists('neiva_abort')) {
        neiva_abort(404, 'No se encontró el trámite solicitado.');
    }
                                                ...
                                                <div>
                                                    ...
                                                    <div id="documentEditor" class="pj-document-editor" contenteditable="true">
                                                        ...
                                                        <div class="pj-resolution-number">
                                                            <strong>RESOLUCION No. <span id="resolucion_numero_val" contenteditable="true"><?php echo htmlspecialchars($next_res); ?></span></strong>
                                                        </div>
...
<script>
    ...
    async function guardarDocumento() {
        ...
        try {
            ...
            const numValElem = document.getElementById("resolucion_numero_val");
            if (numValElem) {
