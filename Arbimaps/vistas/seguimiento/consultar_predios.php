...
$prediosDataUrl = neiva_app_url('Arbimaps/api/predios_dataset.php');
?>
...
<script>
    const prediosDataUrl = <?= json_encode($prediosDataUrl, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) ?>;
    let predios = [];
