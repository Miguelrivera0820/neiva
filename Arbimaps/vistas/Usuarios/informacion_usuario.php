                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-10 p-3">
                            <div class="row p-3">
                                ...
                                <div class="col-md-6 p-1 px-2 my-1">
                                    <label class="form-label fw-bold">NÃºmero de documento</label>
                                    <div class="input-group shadow-sm">
                                        <span class="input-group-text"><i class="bi bi-person-vcard"></i></span>
                                        <!-- Si NO quieres que lo cambien, dÃ©jalo readonly -->
                                ...
                                <div class="col-md-6 p-1 px-2 my-1">
                                    <label class="form-label fw-bold">NÃºmero de celular</label>
                                    <div class="input-group shadow-sm">
                                ...
                                <div class="col-md-6 p-1 px-2 my-1">
                                    ...
                                    <div class="input-group shadow-sm">
                                        ...
                                        <select class="form-select" name="rol_usuario" required>
                                            ...
                                            <?php
                                            $roles = [
                                                "atencion_procedencia" => "AtenciÃ³n Procedencia",
                                                "componente_economico" => "Componente Economico",
                                                "control_calidad" => "Control de Calidad",
                                                "consolidacion" => "ConsolidaciÃ³n",
                                                "coordinacion_tecnica" => "CoordinaciÃ³n Tecnica",
                                                ...
                                                "revision_juridica" => "RevisiÃ³n Juridica",
                                ...
                                <div class="col-md-6 p-1 px-2 my-1">
                                    <label class="form-label fw-bold">Nueva contraseÃ±a (opcional)</label>
                                    <div class="input-group shadow-sm">
