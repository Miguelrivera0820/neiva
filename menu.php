...
<!-- Topbar -->
<nav class="navbar navbar-expand rounded-4 topbar mb-4 static-top shadow" style="background-color: #002F55;border-radius: 12px;">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline small" style="color: #ffffff;">Usuario</span>
